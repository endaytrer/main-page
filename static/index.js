...
let prompt = 'Welcome to <a href="/"><b>endaytrer</b>.com</a>. This is <b>Daniel Gu</b>&apos;s personal website, which has a command line interface. <br/>You can also use the links below to quickly access this website.<br/><br/><span class="gray"> - Play tetris?</span> <a href="/tetris">Tetris</a> <br/> <span class="gray"> - Have a look at my calculator?</span> <a href="/calculator">Calculator</a> <br/> <span class="gray"> - Have a look at my sorting demo?</span> <a href="/sort">Sort</a> <br/> <span class="gray"> - Play Wordle?</span> <a href="/wordle">Wordle</a> <br/> <span class="gray"> - Who am I exactly?</span> <a onclick="toggleProfile()" href="#">Profile</a><br/><br/>Type <span class="green">"help"</span> to show all the available commands, type <span class="green">"start"</span> to show this prompt again.<br/><br/>';
...
window.onload = async () => {
    ...
    for (let blog of blogList) {
        const {name, title, lastModified} = blog;
